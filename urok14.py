...
#     else:
#         return "Доступ запрещен"
# print(validate_user("Иван",20))
# print(validate_user("",20))
# print(validate_user("Гоша",15))
...
# print(validate_product("apple",20))
# print(validate_product("",20))
# print(validate_product("apple",-20))
...
# print(validate_email("calorekz@gmail.com"))
# print(validate_email("calorekzgmailcom"))
...
# print(check_course_access(11,True))
# print(check_course_access(10,False))
# print(check_course_access(5,False))
